...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'proximos-liquidar', loadComponent: () => import('./features/loans/proximos-liquidar.component').then(m => m.ProximosLiquidarComponent), canActivate: [permissionGuard(['prestamos.proximos'])] },
      //{ path: 'importar-creditos', loadComponent: () => import('./features/loans/import-loans.component').then(m => m.ImportLoansComponent), canActivate: [permissionGuard(['prestamos.importar'])] },
       {path: 'carga-manual',loadComponent: () => import('./features/loans/carga-credito-actual.component').then(m => m.CargaCreditoActualComponent), canActivate: [permissionGuard(['prestamos.importar'])] },
      { path: 'eliminar-mora',loadComponent: () => import('./features/payments/eliminar-mora.component').then(m => m.EliminarMoraComponent), canActivate: [permissionGuard(['moratorios.eliminar'])] },
