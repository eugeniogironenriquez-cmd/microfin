...
export class ShellComponent {
  ...
  private readonly navItems: NavItem[] = [
    ...
    { label: 'Monitor cartera',  icon: 'monitor_heart', route: '/cartera/monitor',  perm: 'cartera.semaforo' },
    { label: 'Gestión cobranza', icon: 'support_agent', route: '/gestor-cobranza',  perm: 'cobranza.gestor' },
    { label: 'Semáforo',         icon: 'tune',          route: '/semaforo-config',  perm: 'config.editar' },
